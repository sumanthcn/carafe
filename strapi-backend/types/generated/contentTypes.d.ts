...
export interface ApiEmailSubscriberEmailSubscriber
  ...
  info: {
    description: 'Users who subscribed to receive promotional emails and updates';
...
export interface ApiGlobalSettingGlobalSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site settings and configurations';
  ...
  attributes: {
    ...
    navigation: Schema.Attribute.Component<'elements.nav-item', true>;
    openingHours: Schema.Attribute.Component<'elements.opening-hours', true>;
    publishedAt: Schema.Attribute.DateTime;
    siteDescription: Schema.Attribute.Text;
    siteName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Carafe Coffee House & Roasters'>;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Homepage content for Carafe Coffee';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cultureSection: Schema.Attribute.Component<'sections.brand-story', false>;
    ...
    tasteTheCraft: Schema.Attribute.Component<
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wholesaleSection: Schema.Attribute.Component<
      'sections.wholesale-section',
      false
    >;
  };
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'CMS-driven content pages';
    displayName: 'Pages';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiProductCategoryProductCategory
  ...
  info: {
    description: 'Categories for coffee products';
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Coffee products for the shop';
...
export interface ApiSubscriptionSubscription
  ...
  info: {
    description: 'Coffee subscription plans';
  ...
  attributes: {
    coffeeAmount: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currency: Schema.Attribute.Enumeration<['EUR', 'GBP', 'USD']> &
    ...
    frequency: Schema.Attribute.Enumeration<['weekly', 'biweekly', 'monthly']> &
      Schema.Attribute.Required;
    image: Schema.Attribute.Media<'images'>;
    isActive: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    pricePerDelivery: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
